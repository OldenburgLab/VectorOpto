...
% This is the analysis file designed to run the offline calibration
% necessary to generate all optical figures seen in Bounds et al 2023. This
% analysis is based on the Suite2P output files which were less reliable
% than the Caiman extracted Data and not used in the final manuscript
% Written by Ian Anton Oldenburg 2018-2023
...
%% loadLists - Pointers to all relevant files
...
% loadPath = 'T:\Outfiles';
loadPath = 'C:\Users\io105-adm\Dropbox\Ai203 Datasets'; %repository of extracted data
...
%use ind 8 for example
for ind = 4:numExps; %first few experiments did not attempt complete write
