...
% This is the analysis file designed to run the offline analysis of the
% distributed spiking approach presented in Bounds et al 2023.
% This file compares non-VOIDA experiments using the consolodated pipeline 
